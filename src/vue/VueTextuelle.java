...
public class VueTextuelle extends JPanel implements Observer, Visiteur
{
	...
	/**
	 * Méthode selectionner une livraison on selectionant la ligne dans la table GridView
	 * @param Livraison
	 */
	...
	/**
	 * Méthode qui selectionne la livraison dans la vue textuelle
	 */
	...
	/**
	 * Méthode qui selectionne la livraison dans le système
	 * @param evt
	 */
	...
	/**
	 * Méthode qui visite la demande après un appel accepte dans la demande de livraison
	 */
	@Override
	...
	/**
	 * Méthode qui mis à jour la liste des livraisons une fois l'itinéraire est changé en provoquant un appel accepte
	 */
	@Override
	...
	/**
	 * Méthode qui active les boutons
	 */
	...
	/**
	 * Méthode qui remplit la table grid par une demande de livraison Ordonnée
	...
	/**
	 * Méthode qui calcule la taille des fenêtre de livraison dans la demande
	 * @param itFen
	 * @return
	 */
	...
	/**
	 * Méthode qui remplit la table grid view par la demande de livraison non ordonnée
	 * @param DemandeLivraison
	 */
	@SuppressWarnings("deprecation")
	...
	/**
	 * Méthode qui créé la table grid des livraisons
	 */
	...
	/**
	 * Méthode qui créé les boutons de la vue
	 */
	...
	/**
	 * Méthode qui active et déactive les boutons de modification des livraisons
	 * @param boolean type indique qu'on a dans l'etat de modification alors activé les boutons Valider et Annuler
	 */
...
/**
 * Classe modéle de la table grid view
...
/**
 * Classe modéle de la cellule de la table grid view
 * @author H4101 International Corp
 *
 */
@SuppressWarnings("serial")
