...
public class TextuelleView extends JPanel implements Observer, Visiteur
{
	...
	public TextuelleView(Plan plan, Controleur controleur)
	{
        ...
        jLabel1.setText("S�l�ctionner une fen�tre de livraison :");
        ...
        labelFenetreTexte.setText("Demande de les Livraisons de la fen�tre :");
        ...
        btnDeplacer.setText("D�placer Livraison");
	...
	private void listeNonOrdonnee(DemandeLivraison v) {
		...
		String[] colums = new String[] {"Fen�tre", "Client", "Adresse"};
	...
	private void remplirFenetre(Iterator<FenetreLivraison> f)
	{
		...
		class ListFenetre extends AbstractListModel<String>
		{
			...
			public ListFenetre(Iterator<FenetreLivraison> itFen)
			{
				...
				strings.add("Toute les fen�tres");
